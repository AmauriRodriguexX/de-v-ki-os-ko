...
export function BottomNavBar() {
  ...
  // Highlight sucursal when on that route
  const isActive = (id: string) => {
    if (id === "sucursal") return location.pathname.startsWith("/sucursales");
    return false;
  };
  ...
  return (
    <>
              ...
              >
                <div
                  ...
                  style={{
                    ...
                    color: "#FFFFFF",
                    boxShadow: `0 2px 8px ${item.bg}40`,
                  }}
                >
                  {item.icon}
                </div>
      ...
      {/* Spacer to prevent content from being hidden behind nav bar on mobile */}
      <div className="md:hidden" style={{ height: 75 }} />
    </>
  );
}